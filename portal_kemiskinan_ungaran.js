...
var upload_excel = require('./isine/upload_excel');
...
var login_user = require('./isine/login_user');
var dashboard_user = require('./isine/dashboard_user');
var manajemen_master = require('./isine/manajemen_master');
var manajemen_kemiskinan = require('./isine/manajemen_kemiskinan');
var manajemen_jadwal_akses = require('./isine/manajemen_jadwal_akses');
var kemiskinan = require('./isine/kemiskinan');
var peta_spasial = require('./isine/peta_spasial');
var data_kemiskinan = require('./isine/data_kemiskinan');
...
//end dbf dan shp
// all environments
app.set('port', process.env.PORT || 8860);
...
app.use('/dashboard_user', dashboard_user);
app.use('/manajemen_master', manajemen_master);
app.use('/manajemen_kemiskinan', manajemen_kemiskinan);
app.use('/manajemen_jadwal_akses', manajemen_jadwal_akses);
app.use('/kemiskinan', kemiskinan);
app.use('/peta_spasial', peta_spasial);
app.use('/data_kemiskinan', data_kemiskinan);
