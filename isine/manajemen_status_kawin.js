...
router.get('/', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_status_kawin/list'); 
});

router.get('/insert', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_status_kawin/insert'); 
});

router.get('/edit/:id', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_status_kawin/edit'); 
});
