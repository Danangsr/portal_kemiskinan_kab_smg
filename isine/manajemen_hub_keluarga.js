...
router.get('/', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_hub_keluarga/list'); 
});

router.get('/insert', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_hub_keluarga/insert'); 
});

router.get('/edit/:id', cek_login, function(req, res) {
  res.render('content-backoffice/manajemen_hub_keluarga/edit'); 
});
